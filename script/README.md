...
| `dependabot-ecosystem.yaml` | Uses `actions/setup-node` (npm ecosystem) without a matching `package-ecosystem` entry in dependabot config; triggers DependabotEcosystemRule. |
