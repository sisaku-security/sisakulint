...
func TestDeprecatedNodeRuntimeKnownActions(t *testing.T) {
	tests := []struct {
		...
		{"mise-action v3 is node20", "jdx/mise-action@v3", "", 1, 1},
		{"mise-action v4 is node24", "jdx/mise-action@v4", "", 0, 0},
		{"mise-action sha pinned with tag comment detected but not fixed", "jdx/mise-action@5228313ee0372e111a38da051671ca30fc5a96db", "# v3", 1, 0},
