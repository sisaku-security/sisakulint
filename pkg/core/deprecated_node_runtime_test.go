...
func TestDeprecatedNodeRuntimeKnownActions(t *testing.T) {
	tests := []struct {
		...
		{"action-gh-release v3 is node24", "softprops/action-gh-release@v3", "", 0, 0},
		{"goreleaser-action v6 is node20", "goreleaser/goreleaser-action@v6", "", 1, 1},
		{"goreleaser-action v7 is node24", "goreleaser/goreleaser-action@v7", "", 0, 0},
