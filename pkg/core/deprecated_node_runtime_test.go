...
func TestDeprecatedNodeRuntimeKnownActions(t *testing.T) {
	tests := []struct {
		...
		{"setup-buildx-action v3 is node20", "docker/setup-buildx-action@v3", "", 1, 1},
		{"setup-buildx-action v4 is node24", "docker/setup-buildx-action@v4", "", 0, 0},
		{"setup-qemu-action v3 is node20", "docker/setup-qemu-action@v3", "", 1, 1},
		{"setup-qemu-action v4 is node24", "docker/setup-qemu-action@v4", "", 0, 0},
		{"login-action v3 is node20", "docker/login-action@v3", "", 1, 1},
		{"login-action v4 is node24", "docker/login-action@v4", "", 0, 0},
		{"metadata-action v5 is node20", "docker/metadata-action@v5", "", 1, 1},
		{"metadata-action v6 is node24", "docker/metadata-action@v6", "", 0, 0},
		{"build-push-action v5 is node20", "docker/build-push-action@v5", "", 1, 1},
		{"build-push-action v6 gap major is node20", "docker/build-push-action@v6", "", 1, 1},
		{"build-push-action v7 is node24", "docker/build-push-action@v7", "", 0, 0},
...
func TestDeprecatedNodeRuntimeFixStep(t *testing.T) {
	tests := []struct {
		...
		{"setup-buildx-action v3 bumped to v4", "docker/setup-buildx-action@v3", "docker/setup-buildx-action@v4"},
		{"login-action v3 bumped to v4", "docker/login-action@v3", "docker/login-action@v4"},
		{"metadata-action v5 bumped to v6", "docker/metadata-action@v5", "docker/metadata-action@v6"},
		{"build-push-action v6 gap major bumped to v7", "docker/build-push-action@v6", "docker/build-push-action@v7"},
		{"already node24 untouched", "actions/checkout@v5", "actions/checkout@v5"},
		{"docker action already node24 untouched", "docker/build-push-action@v7", "docker/build-push-action@v7"},
