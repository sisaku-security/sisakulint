...
func TestDeprecatedNodeRuntimeKnownActions(t *testing.T) {
	tests := []struct {
		...
		{"setup-uv v5 is node20", "astral-sh/setup-uv@v5", "", 1, 1},
		{"setup-uv v6 is node20", "astral-sh/setup-uv@v6.0.0", "", 1, 1},
		{"setup-uv v7 is node24", "astral-sh/setup-uv@v7", "", 0, 0},
		{"setup-uv sha pin with v5 comment is detected but not fixed", "astral-sh/setup-uv@a81bbbf8298c0fa03ea29cdc473d45769f953675", "# v5.3.1", 1, 0},
...
func TestDeprecatedNodeRuntimeFixStep(t *testing.T) {
	tests := []struct {
		...
		{"setup-uv v5 bumped to v7", "astral-sh/setup-uv@v5", "astral-sh/setup-uv@v7"},
		{"setup-uv v6 bumped to v7", "astral-sh/setup-uv@v6.0.0", "astral-sh/setup-uv@v7"},
		{"setup-uv v7 untouched", "astral-sh/setup-uv@v7", "astral-sh/setup-uv@v7"},
