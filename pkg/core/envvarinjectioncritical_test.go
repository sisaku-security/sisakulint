...
// TestEnvVarInjectionCriticalPushesSinkRecord verifies that a detected envvar
...
func TestEnvVarInjectionCriticalPushesSinkRecord(t *testing.T) {
	collector := chain.NewSinkCollector()
	rule := EnvVarInjectionCriticalRuleWithCollector(nil, collector)
